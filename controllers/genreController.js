...
exports.genre_delete_get = asyncHandler(async (req, res, next) => {
  // Get details of Genre and all the corresponding books (in parallel)
...
exports.genre_delete_post = asyncHandler(async (req, res, next) => {
  ...
  if (allBooksWithGenre.length > 0) {
    // There is books with Genre. Render in same way as for GET route.
    res.render("genre_delete", {
      title: "Delete Genre",
      genre: genre,
      genre_books: allBooksWithGenre,
    ...
    // There is no books with genre. Delete object and redirect to the list of authors.
